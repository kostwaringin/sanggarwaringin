...
function wpcache_broken_message() {
	...
	if ( false == strpos( $_SERVER['REQUEST_URI'], 'wp-admin' ) && ! $skip_output ) {
		echo '<!-- WP madx Cache is installed but broken. The constant WPCACHEHOME must be set in the file wp-config.php and point at the WP madx Cache plugin directory. -->';
	}
}
