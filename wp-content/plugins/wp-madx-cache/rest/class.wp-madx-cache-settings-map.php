...
class WP_madx_Cache_Settings_Map {
	/**
	...
	public static $map = array(
		...
		'is_madx_cache_enabled' => array(
			'global' => 'madx_cache_enabled',
			'set'    => 'set_madx_cache_enabled',
		),
		...
		'cache_list' => array(
			'global' => 'wp_madxcache_cache_list',
		),
		...
		'madx_off_cdn_url' => array(
			'option' => 'madx_off_cdn_url',
			'set'    => 'set_madx_off_cdn_url',
		),
		'madx_off_blog_url' => array(
			'option' => 'madx_off_blog_url',
			'set'    => 'set_madx_off_blog_url',
		),
		'madx_off_exclude' => array(
			'option' => 'madx_off_exclude',
			'set'    => 'set_madx_off_exclude',
		),
		'madx_off_include_dirs' => array(
			'option' => 'madx_off_include_dirs',
			'set'    => 'set_madx_off_include_dirs',
		),
		'madxcdn' => array(
			'global' => 'madxcdn',
			'set'    => 'set_madxcdn',
		),
		'wp_madx_cache_debug' => array(
			'global' => 'wp_madx_cache_debug',
		),
		...
		'wp_madx_cache_comments' => array(
			'global' => 'wp_madx_cache_comments',
		),
		'wp_madx_cache_front_page_check' => array(
			'global' => 'wp_madx_cache_front_page_check',
		),
		'wp_madx_cache_front_page_clear' => array(
			'global' => 'wp_madx_cache_front_page_clear',
		),
		'wp_madx_cache_front_page_text' => array(
			'global' => 'wp_madx_cache_front_page_text',
		),
		'wp_madx_cache_front_page_notification' => array(
			'global' => 'wp_madx_cache_front_page_notification',
		),
	);
}
