...
if ( ! defined('WPCACHEHOME') )
	define( 'WPCACHEHOME', WP_PLUGIN_DIR . '/wp-madx-cache/' );

$cache_compression = 0; // madx cache compression
$cache_enabled = false;
...
// change to relocate the madxcache plugins directory
...
$wp_madx_cache_advanced_debug = 0;
$wp_madx_cache_front_page_text = '';
$wp_madx_cache_front_page_clear = 0;
$wp_madx_cache_front_page_check = 0;
$wp_madx_cache_front_page_notification = '0';

$wp_cache_anon_only = 0;
$wp_madxcache_cache_list = 0;
$wp_cache_debug_to_file = 0;
$wp_madx_cache_debug = 0;
