...
function scossdl_off_options() {
	...
	<?php if ( get_home_url() !== $ossdl_off_blog_url ) { ?>
		<p><?php printf( __( '<strong style="color: red">WARNING:</strong> Your siteurl and homeurl are different. The plugin is using %s as the homepage URL of your site but if that is wrong please use the filter "ossdl_off_blog_url" to fix it.', 'wp-madx-cache' ), '<code>' . esc_html( $ossdl_off_blog_url ) . '</code>' ); ?></p>
	<?php } ?>
		...
		<table class="form-table"><tbody>
			<tr valign="top">
				...
				<th scope="row"><label for="ossdlcdn"><?php esc_html_e( 'Enable CDN Support', 'wp-madx-cache' ); ?></label></th>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="ossdl_off_cdn_url"><?php esc_html_e( 'Site URL', 'wp-madx-cache' ); ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label for="ossdl_off_cdn_url"><?php esc_html_e( 'Off-site URL', 'wp-madx-cache' ); ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label for="ossdl_off_include_dirs"><?php esc_html_e( 'Include directories', 'wp-madx-cache' ); ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label for="ossdl_off_exclude"><?php esc_html_e( 'Exclude if substring', 'wp-madx-cache' ); ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label for="ossdl_cname"><?php esc_html_e( 'Additional CNAMES', 'wp-madx-cache' ); ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row" colspan='2'><label><input type='checkbox' name='ossdl_https' value='1' <?php checked( $ossdl_https ); ?> /><?php esc_html_e( 'Skip https URLs to avoid "mixed content" errors', 'wp-madx-cache' ); ?></label></th>
			</tr>
		</tbody></table>
		...
		<p><?php _e( 'CDN functionality provided by <a href="https://wordpress.org/plugins/ossdl-cdn-off-linker/">OSSDL CDN Off Linker</a> by <a href="http://mark.ossdl.de/">Mark Kubacki</a>', 'wp-madx-cache' ); ?></p>
	<?php
}
