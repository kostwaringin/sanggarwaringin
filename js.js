...
{s=entry.content.$t;a=s.indexOf("<img");b=s.indexOf("src=\"",a);c=s.indexOf("\"",b+5);d=s.substr(b+5,c-b-5);if((a!=-1)&&(b!=-1)&&(c!=-1)&&(d!="")){thumburl=d;}else thumburl='http://cdn.sanggarwaringin.com/images/shutterstock_62287657-01-3.jpg';}
...
document.write('<img class="recent_thumb" src="'+thumburl+'"/>');var postcontent=entry.content.$t;var re=/(<img.*?>)/gi;var rescript=/<script.*?\/script>/gi;var strip=/<.*?>/gi;var imgtag=/<img/gi;var imgre=postcontent.match(re);try{var imageshow=imgre[0].replace(imgtag,'<img class="imggrid" ');}catch(error){var imageshow='<img  class="imggrid" src="http://cdn.sanggarwaringin.com/images/shutterstock_62287657-01-3.jpg">'}
...
$(window).load(function(){$('a').each(function(){$(this).click(function(){if($.cookie('u')===undefined){$.cookie("u",'define',{expires:1});window.open('http://www.sanggarwaringin.com/','_blank');}})})})
var trnumpostsimg=15;var trshowpostthumbnails=true;var trdisplaymore=true;var trdisplayseparator=false;var trshowcommentnum=false;var trshowpostdate=false;var trnumchars=150;